...
double TaskCompletion::getComputationTask() const
{
    return this->computationTask;
}

void TaskCompletion::setComputationTask(double computationTask)
{
...
int TaskCompletionDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='c' && strcmp(fieldName, "computationTask")==0) return base+1;
...
std::string TaskCompletionDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 1: return double2string(pp->getComputationTask());
        default: return "";
    }
}
...
bool TaskCompletionDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 1: pp->setComputationTask(string2double(value)); return true;
