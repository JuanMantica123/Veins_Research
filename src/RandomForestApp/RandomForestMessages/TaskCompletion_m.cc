//
// Generated file, do not edit! Created by nedtool 5.1 from src/RandomForestApp/RandomForestMessages/TaskCompletion.msg.
//
...
TaskCompletion::TaskCompletion(const char *name, short kind) : ::WaveShortMessage(name,kind)
{
...
TaskCompletion::TaskCompletion(const TaskCompletion& other) : ::WaveShortMessage(other)
{
    copy(other);
}
...
int TaskCompletion::getVirtualServerId() const
{
    return this->virtualServerId;
}

void TaskCompletion::setVirtualServerId(int virtualServerId)
{
...
void TaskCompletion::setComputationWork(double computationWork)
{
    this->computationWork = computationWork;
}

double TaskCompletion::getComputationPower() const
{
    return this->computationPower;
}

void TaskCompletion::setComputationPower(double computationPower)
{
...
TaskCompletionDescriptor::TaskCompletionDescriptor() : omnetpp::cClassDescriptor("TaskCompletion", "WaveShortMessage")
{
...
int TaskCompletionDescriptor::getFieldArraySize(void *object, int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    TaskCompletion *pp = (TaskCompletion *)object; (void)pp;
    switch (field) {
        default: return 0;
    }
}

const char *TaskCompletionDescriptor::getFieldDynamicTypeString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
std::string TaskCompletionDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
bool TaskCompletionDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
void *TaskCompletionDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
